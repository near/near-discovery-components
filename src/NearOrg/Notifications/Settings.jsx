...
const IosNotification = () => (
  <Text>
    ...
    In order to enable Mobile Browser notifications on iOS, you will also need to add
    near.org as a icon to your home screen. Click on the share icon, and then tap on{" "}
