...
const ContentGrid = styled.div`
  ...
  grid-template-columns: ${({ gridEnabled }) =>
    gridEnabled ? "minmax(0, 1fr) minmax(0, 1fr)" : "minmax(0, 7fr) minmax(0, 1fr)"};
  gap: 2rem;
            ...
            {state.selectedTab === "Event Guide" && (
              <Section>
                ...
                {selectedSubTab === "Everyone" && (
                  <>
                    <P1>
                      <H2>Earn NCONs and Help Decide the Featured App on B.O.S.</H2>
                    </P1>
                    ...
                    <P1>
                      <S1>🔗</S1> #NEARConAppLibrary #LikeToInnovate #NEARCon2023
                    </P1>
                  </>
                )}
