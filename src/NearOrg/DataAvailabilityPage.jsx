          ...
          <PatternContent>
            <Flex gap="32px" direction="column" alignItems="center">
              ...
              <Text size="text-l" mobileSize="text-base">
                Simplify and lower costs in your rollup network by using NEAR as the
                Data Availability (DA) Layer in your Rollup Stack
              </Text>
            </Flex>
          </PatternContent>
        </Pattern>
      ...
      <Container>
        <Flex direction="column" gap="24px">
          ...
          <Text size="text-2xl" mobileSize="text-l" style={{ maxWidth: "808px" }}>
            ...
            transaction data on a blockchain with a proven trajectory of 100% uptime
            over its lifetime.
          </Text>
        </Flex>
            ...
            content: (
              <Flex direction="column" gap="60px">
                <Flex direction="column" gap="24px">
                  ...
                  <Text>
                    Storing calldata on NEAR Protocol is approximately 8000x cheaper
                    than storing the same amount of data on Ethereum.
                  </Text>
                </Flex>
                ...
                <Flex direction="column" gap="24px">
                  ...
                  <Text>
                    A trustless off-chain light client for NEAR provides easy access
                    to validate that rollup data was stored on-chain.
                  </Text>
                </Flex>
                ...
                <Flex direction="column" gap="24px">
                  ...
                  <Text>
                    NEAR readily provides an RPC to easily retrieve the on-chain data
                    from anywhere
                  </Text>
                </Flex>
        ...
        <Flex direction="column" gap="50px" alignItems="center">
          ...
          >
            ...
            <Text size="text-l" mobileSize="text-l" style={{ maxWidth: "600px" }}>
              Efficiently store state data and commitments on a NEAR contract for
              your L2 rollup.
            </Text>
          </Flex>
