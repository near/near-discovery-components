...
if (!moderationData || moderationData.length > 0 || !accountId || !blockHeight || !contentTypeKey || !moderationType) {
  return (
...
if (typeof accountFound === "string" || typeof accountFound[""] !== "undefined") {
  const moderationAction = typeof accountFound === "string" ? accountFound : accountFound[""];
  const moderationLabel = typeof moderationAction === "string" ? moderationAction : moderationAction.label;
  return (
    <div className="alert alert-info mx-3" role="alert">
      {moderationType === "self"
