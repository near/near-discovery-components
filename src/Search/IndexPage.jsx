...
return (
  <Wrapper>
    ...
    {showFacets && state.search && (
      <Facets>
        <Widget
          src="${REPL_CHAOTIC_TEMPEST}/widget/Facets"
          props={{
            facets,
            onFacetClick,
        ...
        <Items>
          {state.search.profiles.map((profile, i) => (
            <Item key={profile.accountId}>
              <Widget
                src="${REPL_CHAOTIC_TEMPEST}/widget/AccountProfileCard"
                props={{
        ...
        <Items>
          {state.search.components.map((component, i) => (
            <Item key={component.accountId + component.widgetName}>
              <Widget
                src="${REPL_CHAOTIC_TEMPEST}/widget/ComponentCard"
                props={{
      ...
      <Group>
        ...
        <Items>
          {state.search.postsAndComments.map((post, i) => (
            ...
            >
              <Widget
                src="${REPL_CHAOTIC_TEMPEST}/widget/SearchPost"
                props={{
    ...
    {showPagination &&
      ...
      state.paginate.hitsTotal > state.paginate.hitsPerPage && (
        <Widget
          src="${REPL_CHAOTIC_TEMPEST}/widget/Paginate"
          props={{
    ...
    {!props.disableInsights && (
      <Widget
        src="${REPL_CHAOTIC_TEMPEST}/widget/Insights"
        props={{
          event: state.event,
